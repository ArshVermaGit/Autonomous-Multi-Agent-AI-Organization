...
def list_bedrock_models():
    print(f"Checking available foundation models in {os.getenv('AWS_REGION', 'us-east-1')}...")
    try:
        ...
        if not nova_models:
            print("❌ No Amazon Nova models found. Make sure you have requested access in the AWS Console for this region.")
            return

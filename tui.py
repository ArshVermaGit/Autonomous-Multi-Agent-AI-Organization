...
class ProximusNovaTUI(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Input(placeholder="➜ Type a goal (e.g. 'Build a Next.js landing page...')", id="cmd_input")
        yield Footer()
    ...
    def on_mount(self) -> None:
        ...
        log.write("[bold cyan]Mounting Model Context Protocol (MCP): [/][bold green][OK][/]")
        log.write("[bold cyan]Connecting to Amazon Bedrock Nova Foundation: [/][bold green][READY][/]")
    ...
    async def simulate_execution(self, command: str) -> None:
        ...
        log.write("[bold yellow]\\[System][/] ➜ Executing terminal command mapping context.")
        await asyncio.sleep(2.0)
        log.write("[bold green]\\[Success][/] Task simulated successfully. (Run full system to see actual agent workflows).")

...
"""
    ...
    def _extract_plan_fallback(self, idea: str) -> Dict[str, Any]:
        return {
            ...
            "mvp_features": [
                {"name": "User Authentication", "priority": "P0", "description": "Secure login/register"},
                {"name": "Core Dashboard", "priority": "P0", "description": "Main user interface"},
                {"name": "Data Management", "priority": "P1", "description": "CRUD operations"},
                {"name": "Notifications", "priority": "P2", "description": "Email/in-app alerts"}
            ],
            "milestones": [
                {"phase": "Architecture", "duration_days": 1, "deliverables": ["System design", "DB schema"]},
                {"phase": "Backend", "duration_days": 2, "deliverables": ["API", "Auth", "DB models"]},
                {"phase": "Frontend", "duration_days": 2, "deliverables": ["UI", "API integration"]},
                {"phase": "QA + Deploy", "duration_days": 1, "deliverables": ["Tests", "AWS deployment"]}
            ],
            "risk_assessment": [
                {"risk": "Cost overrun", "impact": "High", "mitigation": "Monitor with Finance agent"},
                {"risk": "Scope creep", "impact": "Medium", "mitigation": "Strict MVP boundaries"}
            ],

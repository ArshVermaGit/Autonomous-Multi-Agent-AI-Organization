...
"""
    ...
    async def run(
        ...
        **kwargs
        ...
        logger.info("DevOps: Deployment complete", url=deployment_result.get("public_url"))
        return {
    ...
    async def _simulate_deployment(self, project_name: str, context: Any) -> Dict[str, Any]:
        ...
        return {
            ...
            "cloudfront_domain": f"d1234abcd.cloudfront.net",
    ...
    def _generate_terraform(self, arch: Dict[str, Any], project_name: str) -> Dict[str, str]:
        return {

...
files = (
    glob.glob("orchestrator/**/*.py", recursive=True)
...
for fpath in files:
    ...
    new_content = new_content.replace(
        "data: dict[str, Any] = None", "data: dict[str, Any] | None = None"
    )
    new_content = new_content.replace(
        "properties: dict[str, Any] = {}", "properties: dict[str, Any] | None = None"
    )
    new_content = new_content.replace(
    ...
    new_content = new_content.replace(
        "tags: list[str] = None", "tags: list[str] | None = None"
    )
    new_content = new_content.replace(
    ...
    new_content = new_content.replace(
        "context: Any = None", "context: Any | None = None"
    )
